...
class DNSManager:
    ...
    def set_tsig_key(self, keyname: str, secret: str, algorithm: str = 'hmac-sha256') -> None:
        """
    ...
    def query(self, qname: str, rdtype: str = 'A', rdclass: str = 'IN') -> Optional[dns.message.Message]:
        """
        Perform a DNS query
        ...
        try:
            ...
            if self.tsig_keyring:
                query.use_tsig(self.tsig_keyring, self.tsig_keyname)
