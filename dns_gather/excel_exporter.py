...
class ExcelExporter:
    ...
    def create_ptr_records_sheet(self, wb: Workbook, zones: List[ZoneInfo],
                                  records_by_zone: dict) -> None:
        """
        ...
        Args:
            wb: Workbook object
            zones: List of ZoneInfo objects
            records_by_zone: Dictionary mapping zone names to lists of
                            DNSRecord objects
        """
    ...
    def create_cname_records_sheet(self, wb: Workbook, zones: List[ZoneInfo],
                                    records_by_zone: dict) -> None:
        """
    ...
    def create_srv_records_sheet(self, wb: Workbook, zones: List[ZoneInfo],
                                  records_by_zone: dict) -> None:
        """
    ...
    def create_aaaa_records_sheet(self, wb: Workbook, zones: List[ZoneInfo],
                                   records_by_zone: dict) -> None:
        """
    ...
    def extract_ip_from_ptr(self, zone_name: str, record_name: str) -> str:
        ...
        try:
            ...
            if zone_name.endswith('.ip6.arpa'):
                ...
                ipv6_formatted = ':'.join(
                    [ipv6_hex[i:i+4] for i in range(0, len(ipv6_hex), 4)]
                )
